...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '5881587178:AAGkAj2wIBzCs9VaLHS3pY2u-NwmtU1z8E8' # Get it from https://t.me/BotFather
    APP_ID = '26894972' # Get it from my.telegram.org/apps
    API_HASH = '2e71f86c38d020023834faccfa9aeea9' # Get it from my.telegram.org/apps
